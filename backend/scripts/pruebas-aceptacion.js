 ...
 *   E2E_PASSWORD  Contrasena del administrador (OBLIGATORIA: el seed ya no
 *                 crea contrasenas por defecto). Definela con
 *                 SEED_ADMIN_PASSWORD al poblar la base, o use la
 *                 contrasena aleatoria que el seed mostro una sola vez.
...
if (!ADMIN_PASSWORD || !VENDEDOR_PASSWORD) {
  console.error(
    '[e2e] Faltan E2E_PASSWORD y/o E2E_VENDEDOR_PASSWORD: el seed ya no crea\n' +
      '      contrasenas por defecto. Defina SEED_ADMIN_PASSWORD y\n' +
      '      SEED_VENDEDOR_PASSWORD al poblar la base, o use las contrasenas\n' +
      '      aleatorias que el seed mostro una sola vez:\n' +
